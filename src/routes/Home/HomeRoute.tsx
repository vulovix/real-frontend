      ...
      <Stack gap="md">
        ...
        <Card>
          <Text size="sm" c="dimmed">
            Navigate using the header links or the buttons above to see Redux-Saga and Redux Thunk
            in action. Each feature demonstrates different approaches to handling asynchronous state
            management.
          </Text>
        </Card>
      </Stack>
